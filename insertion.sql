...
INSERT INTO Departement VALUES (1, 'Département A', 1, '1234567890');
INSERT INTO Departement VALUES (2, 'Département B', 2, '0987654321');

-- Inserts pour la table Reservation
...
INSERT INTO Service VALUES (1, 101, 'Département A', TO_DATE('02-02-2023', 'DD-MM-YYYY'), TO_DATE('02-02-2023 10:00', 'DD-MM-YYYY HH24:MI'), 'Service A', 50.00, 2, 1);
INSERT INTO Service VALUES (2, 201, 'Département B', TO_DATE('12-03-2023', 'DD-MM-YYYY'), TO_DATE('12-03-2023 15:30', 'DD-MM-YYYY HH24:MI'), 'Service B', 75.00, 1, 2);
